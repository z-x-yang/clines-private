...
class PIPELINE:
    ...
    def call_single(self, ehr, prev_ehr = None):
        ...
        print("clean_results (after parsing):", clean_results, "\n####################\n")
        
        # Information Extraction
        self.model.new_chat()
        query_info = self.prompt_info.apply_template({'note': ner_results})
        info_results = self.model(query_info)
        print("info_results (before parsing):", self.parse_result(info_results), "\n####################\n")
        ...
        print("info_results (after parsing):", info_results, "\n####################\n")
        # raise
