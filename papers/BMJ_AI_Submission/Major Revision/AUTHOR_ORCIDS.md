# Author ORCIDs for BMJ Digital Health & AI Submission

Manuscript: **CLINES: Clinical LLM-based Information Extraction and Structuring Agent** (`bmjdh-2026-000027`)
...
| 8 | Huaiyuan Ying | Tsinghua Stat & Data Sci | **0009-0008-9008-5293** | ✅ Provided by Zongxin 2026-05-28 (corrects earlier WebSearch hit) |
...
| 11 | Sheng Yu | Tsinghua Stat & Data Sci | **0000-0002-6347-0507** | ✅ Provided by Zongxin 2026-05-28 (corrects earlier WebSearch hit; matches author_template.tsv) |
...
- **Submission system**: The BMJ submission portal (ScholarOne) has a per-author ORCID field. Each author can link their ORCID at the submission step.
- **Manuscript text**: Optionally, on the title page or contributors section as `\textsuperscript{ORCID: ...}` after each author name, but this is not required by BMJ's editorial style.
- **For corresponding authors**: ORCID is now **strongly encouraged** by BMJ; ensure Isaac Kohane and Tianxi Cai both have ORCIDs linked.
