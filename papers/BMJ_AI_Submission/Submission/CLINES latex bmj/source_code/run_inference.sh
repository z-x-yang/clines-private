...
# file that is .gitignored). The earlier hardcoded values were removed when the
# legacy https://azure-ai-dev.hms.edu endpoint was deprecated; the current HMS
# endpoint is https://azure-ai.hms.edu (key obtained from the HMS SharePoint).
