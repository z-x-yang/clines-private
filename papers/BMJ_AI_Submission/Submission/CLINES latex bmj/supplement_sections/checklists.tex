...
4. Model performance, evaluation metrics, uncertainty & Results; Figures~3--4; Supplementary detailed-metrics and IAA tables \\
5. Model examination (error analysis, ablation, robustness) & Results (ablation, hallucination analysis, note-length); Figure~4; Supplementary hallucination and consistency sections \\
...
Model performance and uncertainty quantification & Results; Figures~3--4; Supplementary detailed-metrics (bootstrap 95\% CIs) \\
Model evaluation, comparison with baselines, ablation & Results; Figure~4; Supplementary tables \\
