...
| EXP-E | E5 | Hallucination 5-class FP taxonomy | P0 | PASS | rule-based 7,171 FP + 500 GPT-4.1 judge 全跑完（0 失败，mean conf 0.985） | Judge-refined (HT extrapolation): val/date 43.2% / wrong_code 13.5% / fabricated 11.1% / annotation-gap 15.2% / boundary 8.5% / assertion 8.6% of FP；true hallucination = 84.8% of FP = 45.2% of 13,454 preds（rule-based 27% fabricated 被 judge 修正到 11%）；40-row human val sample 留给 user post-R1 | experiments/EXP-E_hallucination_taxonomy.md |
