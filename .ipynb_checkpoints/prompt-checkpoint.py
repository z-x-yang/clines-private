...
'''
            ...
            self.template = '''
You will be provided with an electronic health record from a patient with the entities extracted (marked by <KEY> and </KEY>) in this record. Your task is to find the event date for each entity. 
...
Your output should be in JSON format, which should be a list of [admission date, discharge date]. If this does not apply to the record provided, for example, use None to fill up the value.
